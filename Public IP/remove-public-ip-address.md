...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>PublicIP</td>
      <td>string</td>
      <td>The specific public IP to remove. A server may have more than one public IP, and the list of available ones can be retrieved from the call to [Get Server](../Servers/get-server.md).</td>
      <td>Yes</td>
    </tr>
  </tbody>
</table>
