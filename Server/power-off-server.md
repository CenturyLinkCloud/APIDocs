...
There is an equivalent V2 API that should be used instead. Please use the Power Operations | <a href="../v2/#power-operations-power-off-server">Power Off Server</a> API.
</div>
