...
PowerOffServer
<p>Powers off the server.</p>
URL
<pre>REST: https://api.tier3.com/REST/Server/PowerOffServer/&lt;format&gt;<br />SOAP: https://api.tier3.com/SOAP/Server.asmx?op=PowerOffServer</pre> Request
<h3>Attributes</h3>
<table>
  <tbody>
    <tr>
    ...
    <tr>
      <td>Name</td>
      <td>String</td>
      <td>The name of the Server to power off.</td>
      <td>Yes</td>
    </tr>
  </tbody>
</table>
