...
ArchiveServer
<p>Archives the server.</p>
URL
<pre>REST: https://api.tier3.com/REST/Server/ArchiveServer/&lt;format&gt;<br />SOAP: https://api.tier3.com/SOAP/Server.asmx?op=ArchiveServer</pre> Request
<h3>Attributes</h3>
<table>
  <tbody>
    <tr>
