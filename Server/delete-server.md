...
DeleteServer
<p>Deletes the machine and releases all associated resources.</p>
URL
<pre>REST: https://api.tier3.com/REST/Server/DeleteServer/&lt;format&gt;<br />SOAP: https://api.tier3.com/SOAP/Server.asmx?op=DeleteServer</pre> Request
<h3>Attributes</h3>
<table>
  <tbody>
    <tr>
    ...
    <tr>
      <td>AccountAlias</td>
      <td>String</td>
      <td>The alias of the account that owns the server. If not provided it will assume the account to which the API user is mapped. Providing this value gives you the ability to delete servers in your sub accounts.</td>
      <td>No</td>
    </tr>
    <tr>
      <td>Name</td>
      <td>String</td>
      <td>The name of the Server to delete.</td>
      <td>Yes</td>
    </tr>
  </tbody>
</table>
