...
PowerOnServer
<p>Powers on the server (or resumes from a paused state).</p>
URL
<pre>REST: https://api.tier3.com/REST/Server/PowerOnServer/&lt;format&gt;<br />SOAP: https://api.tier3.com/SOAP/Server.asmx?op=PowerOnServer</pre> Request
<h3>Attributes</h3>
<table>
  <tbody>
    <tr>
