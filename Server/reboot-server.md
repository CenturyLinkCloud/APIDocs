...
RebootServer
<p>Reboots the server (OS reboot).</p>
URL
<pre>REST: https://api.tier3.com/REST/Server/RebootServer/&lt;format&gt;<br />SOAP: https://api.tier3.com/SOAP/Server.asmx?op=RebootServer</pre> Request
<h3>Attributes</h3>
<table>
  <tbody>
    <tr>
    ...
    <tr>
      <td>Name</td>
      <td>String</td>
      <td>The name of the Server to reboot.</td>
      <td>Yes</td>
    </tr>
  </tbody>
</table>
