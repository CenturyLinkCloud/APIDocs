...
GetAllServers
<p>Gets a deep list of all Servers for a given Hardware Group and its sub groups, or all Servers&nbsp;for&nbsp;a given location.</p>
URL
<pre>REST: https://api.tier3.com/REST/Server/GetAllServers/&lt;format&gt;<br />SOAP: https://api.tier3.com/SOAP/Server.asmx?op=GetAllServersResponseMsg</pre> Request
<h3>Attributes</h3>
<table>
  <tbody>
    <tr>
