...
RebootHardwareGroup
<p>Reboot the Hardware Group along with all child groups and servers.</p>
URL
<pre>REST: https://api.tier3.com/REST/Group/RebootHardwareGroup/&lt;format&gt;<br />SOAP: https://api.tier3.com/SOAP/Group.asmx?op=RebootHardwareGroup</pre> Request
<h3>Attributes</h3>
<table>
  <tbody>
    <tr>
    ...
    <tr>
      <td>ID</td>
      <td>Int</td>
      <td>The ID of the Hardware Group to reboot.</td>
      <td>Yes</td>
    </tr>
  </tbody>
</table>
