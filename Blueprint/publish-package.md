...
<div>
  PublishPackage
  <p>Publishes a Blueprint Package for use within the Blueprint Designer.</p>
  URL
  <pre>REST: <code>https://api.tier3.com/REST/Blueprint/PublishPackage/&lt;format&gt;</code> <br />SOAP: <code>https://api.tier3.com/SOAP/Blueprints.asmx?op=PublishPackage</code></pre> Request
  <h3>Attributes</h3>
  <table>
    <tbody>
      <tr>
...
+-----------------+---------------------------------------------+
  ...
  <pre>&lt;PublishPackageRequest&gt;<br />&nbsp; &nbsp; &lt;Classification&gt;2&lt;/Classification&gt;<br />    &lt;Name&gt;Script01.zip&lt;/Name&gt;<br />    &lt;OperatingSystems&gt;<br />        &lt;OS&gt;4&lt;/OS&gt;<br />        &lt;OS&gt;5&lt;/OS&gt;&nbsp;
    ...
    &lt;/OperatingSystems&gt;<br />&nbsp; &nbsp; &lt;Visibility&gt;1&lt;/Visibility&gt;<br />&lt;/PublishPackageRequest&gt;&nbsp;</pre> Response
  <h3>Attributes</h3>
  <table>
    <tbody>
      <tr>
