...
<div class="kb-api-urls">
  <div class="kb-api-urls-inner">
    <p>REST: <span class="url"><code>https://api.tier3.com/REST/SMTPRelay/Overview/</code></span>[format](format =  XML | JSON)</p>
    <p>SOAP: <span class="url"><code>https://api.tier3.com/SOAP/SMTPRelay/Overview/</code></span></p>
  </div>
</div>
