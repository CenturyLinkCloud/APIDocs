...
Create a brand new (sub) account in the  system. Calls to this operation must include an authorization cookie acquired from the [Logon operation](../Authentication/logon.md).
...
| BillingResponsibilityID | Integer | Determines the recipient of the bill.<br/>1 = Account Directly<br/>2 = Parent Account | Yes |
...
| Status | Int | Indicator of whether the account is active or not.<br/><br/>Active = 1<br/> Inactive = 0 |
