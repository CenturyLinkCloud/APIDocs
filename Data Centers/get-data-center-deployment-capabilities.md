...
Gets the list of capabilities that a specific data center for a given account supports, including the deployable networks, OS templates, and whether features like premium storage and shared load balancer configuration are available. Calls to this operation must include a token acquired from the authentication endpoint. See the <a href="/api-docs/v2#authentication-login">Login API</a> for information on acquiring this token.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>array</td>
      <td>Collection of networks that can be used for deploying servers to</td>
    </tr>
    <tr>
      <td>templates</td>
      <td>array</td>
      <td>Collection of available templates in the data center that can be used to create servers from</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>accountID</td>
      <td>string</td>
      <td>Account alias for the account the network exists in</td>
    </tr>
  </tbody>
</table>
